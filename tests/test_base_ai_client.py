...
def test_raises_for_zero_or_unsupported_number(tmp_path: Path) -> None:
    ...
    with pytest.raises(ValueError, match="positive integer"):
        DummyClient(
            api_key="", model="m", api_url="", prompts_dir=prompts_dir_zero, user_prompt_template=user_prompt_zero
        )
    ...
    with pytest.raises(ValueError, match="Unsupported number word"):
        DummyClient(
            api_key="", model="m", api_url="", prompts_dir=prompts_dir_word, user_prompt_template=user_prompt_word
        )
